...
class syncdriverTask extends Task{
	...
	public function run(){
      ...
      //update
      $sql4 = 'insert into game_driver_temp (select b.* from game_driver_trip b left join game_member a on b.PHONE = a.contact  where  unix_timestamp(b.END_DATETIME)>a.driver_time) order by b.id limit 2';
