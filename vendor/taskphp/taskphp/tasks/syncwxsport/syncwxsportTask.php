...
class syncwxsportTask extends Task{
	...
	public function run(){
      ...
      $sql4 = 'insert into game_wxsport_temp (select b.* from game_wxsport b left join game_member a on b.LoginId = a.sign  where  1';
...
// set a.steps = b.Step+a.steps,a.green_max = round(b.Step*0.7*3/1000)+a.green_max,a.green = round(b.Step*0.7*3/1000)+a.green,a.share = round(b.AccuracyNum*4)+a.share,wxsport_time=unix_timestamp(),a.accuracyNum = b.AccuracyNum+a.accuracyNum,a.total_time = b.UserTime+a.total_time where 1 ';
        $sql = 'update game_member a 
inner join  game_wxsport_total b on a.sign = b.LoginId  
set a.steps = b.Step+a.steps,a.green_max = round(b.Step*0.7*3/1000)+a.green_max-a.last_green_sync,a.green = round(b.Step*0.7*3/1000)+a.green-a.last_green_sync,a.share = round(b.AccuracyNum*4),wxsport_time=unix_timestamp(),a.accuracyNum = b.AccuracyNum,a.total_time = b.UserTime,a.last_green_sync=round(b.AccuracyNum*4) where 1 ';
