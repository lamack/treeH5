<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:61:"/data/httpd/zuopai/application/admin/view/module/install.html";i:1501930946;s:53:"/data/httpd/zuopai/application/admin/view/layout.html";i:1501931654;s:46:"./application/common/builder/aside/layout.html";i:1489042526;s:53:"./application/common/builder/aside/blocks/recent.html";i:1489042526;s:53:"./application/common/builder/aside/blocks/online.html";i:1489042526;s:53:"./application/common/builder/aside/blocks/switch.html";i:1489042526;}*/ ?>
<!DOCTYPE html>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <?php if(is_array($need_module) || $need_module instanceof \think\Collection || $need_module instanceof \think\Paginator): $i = 0; $__LIST__ = $need_module;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                            <tr>
                                                ...
                                                <td><a href="http://www..com" target="_blank" data-toggle="tooltip" title="到商城查看该模块"><?php echo $vo['identifier']; ?></a></td>
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="http://www..com" target="_blank" data-toggle="tooltip" title="到商城查看该插件"><?php echo $vo['identifier']; ?></a></td>
                                            <td><?php echo $vo['version']; ?></td>
                                            <td><?php echo $vo['version_need']; ?></td>
                                            <td class="text-center">
                                                <?php echo $vo['result']; ?>
