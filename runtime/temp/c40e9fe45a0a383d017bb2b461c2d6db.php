<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"/data/httpd/treeGame/application/user/view/admin/publics/signin.html";i:1501930919;}*/ ?>
<!DOCTYPE html>
...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="zh"> <!--<![endif]-->
    ...
    <body>
                    ...
                    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                        <div class="push-30-t push-50 animated fadeIn">
                            ...
                            <div class="text-center">
                                <img src="__ADMIN_IMG__/logo-signin.png" alt="框架">
                                <p class="text-muted push-15-t">框架</p>
                            </div>
                            <!-- END Login Title -->
        ...
        <div class="pulldown push-30-t text-center animated fadeInUp">
            <small class="text-muted"><span class="js-year-copy"></span> &copy;  <?php echo config('dolphin.product_version'); ?></small>
        </div>
        <!-- END Login Footer -->
